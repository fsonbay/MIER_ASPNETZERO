...
namespace DDM.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : DDMServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("DDM", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
