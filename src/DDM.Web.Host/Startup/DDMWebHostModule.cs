...
using DDM.Web.Startup.ExternalLoginInfoProviders;
...
namespace DDM.Web.Startup
{
    ...
    public class DDMWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public DDMWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DDMWebHostModule).GetAssembly());
        }
