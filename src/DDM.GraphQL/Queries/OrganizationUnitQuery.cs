...
using DDM.Core.Base;
using DDM.Core.Extensions;
using DDM.Dto;
using DDM.Types;

namespace DDM.Queries
{
    public class OrganizationUnitQuery : DDMQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
