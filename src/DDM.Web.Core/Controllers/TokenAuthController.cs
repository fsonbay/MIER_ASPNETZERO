...
using DDM.Web.Authentication.JwtBearer;
using DDM.Web.Authentication.TwoFactor;
using DDM.Web.Models.TokenAuth;
...
namespace DDM.Web.Controllers
{
    ...
    public class TokenAuthController : DDMControllerBase
    {
