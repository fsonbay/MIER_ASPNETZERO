...
namespace DDM.Web.Public.Startup
{
    [DependsOn(
        typeof(DDMWebCoreModule)
    )]
    public class DDMWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public DDMWebFrontEndModule(IWebHostEnvironment env, DDMEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DDMWebFrontEndModule).GetAssembly());
        }
    }
}
