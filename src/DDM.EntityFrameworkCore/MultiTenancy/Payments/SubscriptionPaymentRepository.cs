...
{
    public class SubscriptionPaymentRepository : DDMRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<DDMDbContext> dbContextProvider)
