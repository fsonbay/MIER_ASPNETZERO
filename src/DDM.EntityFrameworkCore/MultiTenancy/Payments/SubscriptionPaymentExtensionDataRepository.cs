...
{
    public class SubscriptionPaymentExtensionDataRepository : DDMRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<DDMDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
