...
namespace DDM.Migrations
{
    ...
    [Migration("20210526162200_Regenerated_SalesInvoiceAdditionalCost6201")]
    partial class Regenerated_SalesInvoiceAdditionalCost6201
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DDM.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DDM.CustomerCategories.CustomerCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DDM.Customers.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DDM.Machines.Machine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DDM.Materials.Material", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DDM.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DDM.SalesOrders.SalesOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("ProcessedBySurabaya")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DDM.VendorCategories.VendorCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DDM.Vendors.Vendor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("DDM.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("DDM.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("DDM.Customers.Customer", b =>
                {
                    b.HasOne("DDM.CustomerCategories.CustomerCategory", "CustomerCategoryFk")
                        .WithMany()
            ...
            modelBuilder.Entity("DDM.SalesOrders.SalesOrder", b =>
                {
                    b.HasOne("DDM.Customers.Customer", "CustomerFk")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DDM.ProductionStatuses.ProductionStatus", "ProductionStatusFK")
                        .WithMany()
            ...
            modelBuilder.Entity("DDM.Vendors.Vendor", b =>
                {
                    b.HasOne("DDM.VendorCategories.VendorCategory", "VendorCategoryFk")
                        .WithMany()
