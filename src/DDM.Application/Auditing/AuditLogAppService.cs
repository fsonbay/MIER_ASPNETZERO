...
using DDM.Auditing.Exporting;
using DDM.Authorization;
using DDM.Authorization.Users;
using DDM.Dto;
using DDM.EntityHistory;
using EntityHistoryHelper = DDM.EntityHistory.EntityHistoryHelper;

namespace DDM.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : DDMAppServiceBase, IAuditLogAppService
    {
