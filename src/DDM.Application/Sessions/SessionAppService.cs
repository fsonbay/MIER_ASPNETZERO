...
using DDM.UiCustomization;
using DDM.Authorization.Delegation;
using DDM.Authorization.Users;

namespace DDM.Sessions
{
    public class SessionAppService : DDMAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = DDMConsts.Currency,
                    CurrencySign = DDMConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = DDMConsts.AllowTenantsToChangeEmailSettings,
