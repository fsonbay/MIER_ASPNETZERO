...
using DDM.Identity;
using DDM.Schemas;
using DDM.Web.Chat.SignalR;
using DDM.Web.Common;
using DDM.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using DDM.Web.IdentityServer;
using DDM.Web.Swagger;
using Stripe;
...
using DDM.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;

namespace DDM.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerDoc("v1", new OpenApiInfo() { Title = "DDM API", Version = "v1" });
            ...
            return services.AddAbp<DDMWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "DDM API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("DDM.Web.wwwroot.swagger.ui.index.html");
