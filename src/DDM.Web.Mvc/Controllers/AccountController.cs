...
using DDM.Authentication.TwoFactor.Google;
using DDM.Authorization;
using DDM.Authorization.Accounts;
using DDM.Authorization.Accounts.Dto;
using DDM.Authorization.Delegation;
using DDM.Authorization.Impersonation;
...
using DDM.Web.Models.Account;
using DDM.Security;
using DDM.Security.Recaptcha;
using DDM.Sessions;
using DDM.Url;
using DDM.Web.Authentication.External;
using DDM.Web.Security.Recaptcha;
using DDM.Web.Session;
using DDM.Web.Views.Shared.Components.TenantChange;

namespace DDM.Web.Controllers
{
    public class AccountController : DDMControllerBase
    {
        ...
        {
            return Url.Action("Index", "Home", new { area = "Portal" });
        }
