...
using DDM.Web.Models.TenantRegistration;

namespace DDM.Web.Controllers
{
    public class TenantRegistrationController : DDMControllerBase
    {
            ...
            try
            {
                    ...
                    !_webUrlService.SupportsTenancyNameInUrl)
                {
                    ...
                    if (loginResult.Result == AbpLoginResultType.Success)
                    {
                        ...
                        return Redirect(Url.Action("Index", "Home", new { area = "Portal" }));
                    }
