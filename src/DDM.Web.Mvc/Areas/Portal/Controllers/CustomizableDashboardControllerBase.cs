...
using DDM.Web.Areas.Portal.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : DDMControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            var userDashboard = await DashboardCustomizationAppService.GetUserDashboard(
                new GetDashboardInput
                {
                    ...
                    Application = DDMDashboardCustomizationConsts.Applications.Mvc
                }
            );
            ...
            return PartialView("~/Areas/Portal/Views/Shared/Components/CustomizableDashboard/_AddWidgetModal.cshtml", viewModel);
        }
        ...
        protected async Task<ActionResult> GetView(string dashboardName)
        {
            ...
            return View("~/Areas/Portal/Views/Shared/Components/CustomizableDashboard/Index.cshtml",
