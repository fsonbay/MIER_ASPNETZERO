$(function () {
    ...
    var _addWidgetModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Portal/' + $('#DashboardName').val() + '/AddWidgetModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/CustomizableDashboard/_AddWidgetModal.js',
