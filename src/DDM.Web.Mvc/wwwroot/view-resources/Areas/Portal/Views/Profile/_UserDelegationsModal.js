(function ($) {
    app.modals.UserDelegationsModal = function () {
        ...
        var _createNewUserDelegationModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Profile/CreateNewUserDelegationModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Profile/_CreateNewUserDelegationModal.js',
