(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Editions/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Editions/_CreateModal.js',
            modalClass: 'CreateOrEditEditionModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Editions/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Editions/_EditModal.js',
            modalClass: 'CreateOrEditEditionModal'
        });

        var _moveTenantsToAnotherEditionModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Editions/MoveTenantsToAnotherEdition',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Editions/_MoveTenantsToAnotherEditionModal.js',
