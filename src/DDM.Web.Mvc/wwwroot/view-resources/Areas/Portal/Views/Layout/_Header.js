(function ($) {
    $(function () {
        ...
        var mySettingsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Profile/MySettingsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Profile/_MySettingsModal.js',
        ...
        var changePasswordModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Profile/ChangePasswordModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Profile/_ChangePasswordModal.js',
        ...
        var changeProfilePictureModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Profile/ChangePictureModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Profile/_ChangePictureModal.js',
        ...
        var userLoginAttemptsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Users/LoginAttemptsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Users/_LoginAttemptsModal.js',
        ...
        var manageLinkedAccountsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Profile/LinkedAccountsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Profile/_LinkedAccountsModal.js',
        ...
        var userDelegationsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Profile/UserDelegationsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Profile/_UserDelegationsModal.js',
