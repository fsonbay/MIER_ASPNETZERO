    ...
    getFormattedMessages: function (messages) {
        $.each(messages, function (index, message) {
            ...
            if (message.message.startsWith('[image]')) {
                ...
                var imageUrl = abp.appPath + 'Portal/Chat/GetImage?id=' + message.id + '&contentType=' + image.contentType;
                ...
                var fileUrl = abp.appPath + 'Portal/Chat/GetFile?id=' + message.id + '&contentType=' + file.contentType;
...
(function ($) {
    $(function () {
        ...
        var url = abp.appPath + 'Portal/Chat/UploadFile';
