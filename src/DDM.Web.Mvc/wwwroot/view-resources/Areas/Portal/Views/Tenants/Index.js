(function () {
    $(function () {
        ...
        var _entityTypeFullName = 'DDM.MultiTenancy.Tenant';
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + "Portal/Tenants/CreateModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Portal/Views/Tenants/_CreateModal.js",
            modalClass: "CreateTenantModal"
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + "Portal/Tenants/EditModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Portal/Views/Tenants/_EditModal.js",
            modalClass: "EditTenantModal"
        });

        var _featuresModal = new app.ModalManager({
            viewUrl: abp.appPath + "Portal/Tenants/FeaturesModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Portal/Views/Tenants/_FeaturesModal.js",
