(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/WebhookSubscription/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/WebhookSubscriptions/_CreateOrEditModal.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        },
                        {
                            ...
                            action: function (data) {
                                window.location = "/Portal/WebhookSubscription/WebhookEventDetail/" + data.record.webhookEventId;
                            }
                        }]
                    }
                },
