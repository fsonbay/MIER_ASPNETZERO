(function () {
    app.modals.EntityTypeHistoryModal = function () {
        ...
        function showEntityChangeDetails(entityChange) {
            var entityChangeDetailModal = new app.ModalManager({
                viewUrl: abp.appPath + 'Portal/AuditLogs/EntityChangeDetailModal',
    ...
    app.modals.EntityTypeHistoryModal.create = function () {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'Portal/Common/EntityTypeHistoryModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Common/Modals/_EntityTypeHistoryModal.js',
