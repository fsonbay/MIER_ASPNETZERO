...
(function ($) {
    ...
    app.UserNotificationHelper = (function () {
        ...
        return function () {
            ...
            /* Example:
            abp.notifications.messageFormatters['DDM.MyNotificationDataType'] = function(userNotification) {
            ...
            */
            ...
            function getUrl(userNotification) {
                switch (userNotification.notification.notificationName) {
                    case 'App.NewUserRegistered':
                        return '/Portal/users?filterText=' + userNotification.notification.data.properties.emailAddress;
                    case 'App.NewTenantRegistered':
                        return '/Portal/tenants?filterText=' + userNotification.notification.data.properties.tenancyName;
            ...
            var openSettingsModal = function () {
                new app.ModalManager({
                    viewUrl: abp.appPath + 'Portal/Notifications/SettingsModal',
                    scriptUrl: abp.appPath + 'view-resources/Areas/Portal/Views/Notifications/_SettingsModal.js',
