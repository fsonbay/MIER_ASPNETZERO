...
using DDM.UiCustomization.Dto;

namespace DDM.Web.TagHelpers
{
    ...
    public class DDMPageSubheaderTagHelper : TagHelper
    {
        ...
        public DDMPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
