...
using DDM.Controls;
using DDM.Dto;
using DDM.Extensions;
using DDM.Localization;
using DDM.UI;
using DDM.UI.Assets;
using DDM.Views;
using DependencyResolver = DDM.Core.Dependency.DependencyResolver;
...
namespace DDM.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "DDM";
