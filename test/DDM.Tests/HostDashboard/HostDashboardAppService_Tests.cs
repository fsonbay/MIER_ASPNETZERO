...
using DDM.MultiTenancy.HostDashboard;
...
namespace DDM.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(DDMDbContext context, SubscriptionPayment subscriptionPayment)
        {
